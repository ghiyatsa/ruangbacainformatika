...
it('similarity api service treats delete not found responses as successful idempotent deletes', function () {
    Setting::query()->create([
        'section' => 'integration',
        'key' => 'similarity_api_url',
        'value' => 'https://similarity.test',
    ...
    Http::fake([
        'https://similarity.test/api/v1/sync/77' => Http::response([
            'message' => 'not found',
        ], 404),
    ]);

    $result = app(SimilarityApiService::class)->delete(77);
