    ...
    return (
        <div className={`relative w-full ${className}`}>
            ...
            {showGradients && items.length > 0 && (
                <>
                    <div
                        className="ease pointer-events-none absolute top-0 right-0 left-0 h-8 bg-gradient-to-b from-popover to-transparent transition-opacity duration-300"
                        style={{ opacity: topGradientOpacity }}
                    ></div>
                    <div
                        className="ease pointer-events-none absolute right-0 bottom-0 left-0 h-12 bg-gradient-to-t from-popover to-transparent transition-opacity duration-300"
