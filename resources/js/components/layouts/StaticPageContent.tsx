        ...
        >
            <div
                className={cn(
                    ...
                    '[&_blockquote]:my-6 [&_blockquote]:border-l-4 [&_blockquote]:border-primary [&_blockquote]:bg-muted/30 [&_blockquote]:py-3 [&_blockquote]:pl-4 [&_blockquote]:pr-4 [&_blockquote]:rounded-r-xl [&_blockquote]:italic [&_blockquote]:text-foreground/90',
                    ...
                    '[&_p]:my-4 [&_p:first-child]:mt-0 [&_p:last-child]:mb-0 [&_p]:leading-8',
                    ...
                    '[&_code]:rounded-md [&_code]:bg-muted/60 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-xs [&_code]:text-foreground [&_pre_code]:p-0 [&_pre_code]:bg-transparent [&_pre_code]:text-sm',
                    '[&_hr]:my-8 [&_hr]:border-t [&_hr]:border-border/60',
                    '[&_img]:my-6 [&_img]:mx-auto [&_img]:max-w-full [&_img]:rounded-2xl [&_img]:shadow-xs',
                )}
