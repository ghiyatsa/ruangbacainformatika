...
interface InternshipReportCatalogHeaderProps {
    total: number;
}

export function InternshipReportCatalogHeader({ total }: InternshipReportCatalogHeaderProps) {
    return (
            ...
            <div className="relative mx-auto max-w-7xl px-6 pt-32 pb-12 sm:pt-40 lg:px-8">
                <Breadcrumb className="mb-8">
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage>Katalog Laporan KP</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                ...
                <div className="flex flex-col gap-4">
                    <div>
                        ...
                        <p className="mt-2 text-muted-foreground">
                            {total.toLocaleString('id-ID')} laporan KP tersedia
