...
function ResultsSummaryBanner({ result }: SimilarityResultsSectionProps) {
    ...
    return (
        <div className="flex flex-wrap items-center justify-between gap-4 rounded-2xl border bg-card/50 px-6 py-4 shadow-sm backdrop-blur-sm">
            ...
            <div className="flex flex-wrap gap-2">
                {counts['SANGAT TINGGI'] > 0 && (
                    <Badge
                        variant="outline"
                        className="border-rose-200 bg-rose-50 px-2.5 py-1 font-semibold text-rose-700 dark:border-rose-900/50 dark:bg-rose-900/20 dark:text-rose-400"
                    >
                ...
                {counts['TINGGI'] > 0 && (
                    <Badge
                        variant="outline"
                        className="border-orange-200 bg-orange-50 px-2.5 py-1 font-semibold text-orange-700 dark:border-orange-900/50 dark:bg-orange-900/20 dark:text-orange-400"
                    >
                ...
                {counts['SEDANG'] > 0 && (
                    <Badge
                        variant="outline"
                        className="border-amber-200 bg-amber-50 px-2.5 py-1 font-semibold text-amber-700 dark:border-amber-900/50 dark:bg-amber-900/20 dark:text-amber-400"
                    >
                ...
                {counts['RENDAH'] > 0 && (
                    <Badge
                        variant="outline"
                        className="border-emerald-200 bg-emerald-50 px-2.5 py-1 font-semibold text-emerald-700 dark:border-emerald-900/50 dark:bg-emerald-900/20 dark:text-emerald-400"
                    >
                ...
                {counts['SANGAT RENDAH'] > 0 && (
                    <Badge
                        variant="outline"
                        className="border-blue-200 bg-blue-50 px-2.5 py-1 font-semibold text-blue-700 dark:border-blue-900/50 dark:bg-blue-900/20 dark:text-blue-400"
                    >
