...
class ThesisImporter extends Importer
{
    ...
    public function resolveRecord(): Thesis
    {
        return Thesis::firstOrNew([
    ...
    {
        $body = 'Impor tesis selesai dan '.Number::format($import->successful_rows).' '.str('baris')->plural($import->successful_rows).' berhasil diimpor.';
